...
You can configure your application to support importing modules using absolute paths. This can be done by configuring a `jsconfig.json` or `tsconfig.json` file in the root of your project (inside src folder). If you're using TypeScript in your project, you will already have a `tsconfig.json` file.
